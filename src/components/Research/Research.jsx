            ...
            <div className="grid grid-cols-3 gap-5">
                <div className="p-3 rounded-md bg-white flex flex-col justify-between">
                    <div className="space-y-3">
                        <img className="rounded-md" src="https://www.mit.edu/files/images/201807/MIT-Brain-Drug-Delivery-03.jpg" alt="" />
                ...
                <div className="p-3 rounded-md space-y-3 bg-white flex flex-col justify-between">
                    <div>
                        <img className="rounded-md" src="https://www.mit.edu/files/images/201807/MIT-Sole-Vibes_0.jpg" alt="" />
                ...
                <div className="p-3 rounded-md space-y-3 bg-white flex flex-col justify-between">
                    <div>
                        <img className="rounded-md" src="https://www.ornl.gov/sites/default/files/styles/large/public/2019-06/2018-p09444.jpg?itok=Gn_T-LLG" alt="" />
                ...
                <div className="p-3 rounded-md space-y-3 bg-white flex flex-col justify-between">
                    <div>
                        <img className="rounded-md" src="https://www.stanford.edu/wp-content/uploads/2017/03/neuroscience-highlight-1499x938.jpg" alt="" />
                ...
                <div className="p-3 rounded-md space-y-3 bg-white flex flex-col justify-between">
                    <div>
                        <img className="rounded-md" src="https://caltech-prod.s3.amazonaws.com/main/images/White-Dwarf-20230505-Magnetic-400p12c64.width-450.gif" alt="" />
                ...
                <div className="p-3 rounded-md space-y-3 bg-white flex flex-col justify-between">
                    <div>
                        <img className="rounded-md" src="https://www.jhu.edu/assets/uploads/2016/05/neural-progenitor-cells-360x240.jpg" alt="" />
