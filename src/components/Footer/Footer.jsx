...
const Footer = () => {
    return (
        // TODO: make tablet responsive
        <footer className="bg-[#1e2434] rounded-lg">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="mt-8 grid grid-cols-1 gap-8 lg:mt-0 lg:grid-cols-3 lg:gap-y-16 mx-16">
                    <div className="space-y-5">
                        <p className="font-medium text-[#ffffff] text-4xl">EduVenue</p>
                        <p className="text-[#ffffff]">EduVenue is the commercial enterprise goal is to facilitate schools and colleges with scholar recruitment throughout all streams and degrees.</p>
                        {/* social icons */}
                ...
                <div className="mt-8 border-t border-gray-100 pt-8">
                    <div className="sm:flex sm:justify-between">
                        <p className="text-xs text-[#ced2d8]">
